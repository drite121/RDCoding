...
&lt;p> Berikut adalah angka yang digenerate menggunakan rand(),
    &lt;?php
        echo(rand());
    ?>
&lt;/p>
...
&lt;div class="col-sm-3"><br>
    &lt;p id="random"> Klik generate untuk memunculkan angka random&lt;/p><br>
...
&lt;/div>
                        ...
                        <div class="border p-3">
                            ...
                            <div class="col-sm-3">
                                <p id="random"> Klik generate untuk memunculkan angka random</p>
